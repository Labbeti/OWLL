...
from onto_classes.OwlreadyOntology import OwlreadyOntology
from onto_classes.RdflibOntology import RdflibOntology
from Config import *
        ...
        if load_type == LoadType.TRY_BOTH:
            ...
            if onto.isLoaded():
                ...
                if onto.isLoaded():
                    ...
                    prt("KO: Load \"%s\" failed with Rdflib too. Cannot read the file." % filepath)
            ...
            if onto.isLoaded():
                ...
                prt("KO: Load \"%s\" with Owlready2 has failed." % filepath)
            ...
            if onto.isLoaded():
                ...
                prt("KO: Load \"%s\" with Rdflib has failed." % filepath)
        else:
